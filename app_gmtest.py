...
debug = True
RESULTS_API_URL = "https://gmtest.neuralit.com/liberation/functions/rpa_process_qc_collection_data?atoken=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9"
API_URL = "https://gmtest.neuralit.com/liberation/functions/rpa_get_qc_collection_details?atoken=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9"
                    ...
                    try:
                        ...
                        if key in ["plaintiff", "defendant", "patientName"]:
                            ...
                            if key == "patientName":
                                ...
                                # if patient_found == 0:
                                #     key = "patient_name_denials"
                                #     for each_entity in extracted_data[key]:
                                #         extracted_value_normalized_1 = normalize_alpha_only(each_entity)
                                #         if soft_match(api_value_normalized, extracted_value_normalized_1):
                                #             print("adding correct count patinet from denials: ", correct_count)
                                #             new_extr_data["patientName"] = each_entity
                                #             correct_count += 1
                                #             format_type = "denials"
                                #
                                #         else:
...
def aaa_fetch_data():
    ...
    try:
        if str(key) == str(inpkey):
            try:
                ...
                # data = {"823797": {
                #     "filepath": "/home/neural/Documents/Python_workspace/QC/jul04/1720078905-828575-collection-qc-joined.pdf",
                #     "plaintiff": "SUPPLIES MADE EASY INC", "defendant": "GEICO", "patientName": "ANTOINETTE MURPHY",
                #     "dos_s": "04/19/2024", "dos_e": "04/19/2024", "initial_amt": "1499.48"}}
    ...
    # TODO
    resp = requests.post(
        f"https://gmtest.neuralit.com/liberation/functions/check_qcprocess_status?&key=LBATQrQzP8qp2YVxWfHlJFV3VZ1mWIO7&username={username}")
