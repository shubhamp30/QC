...
def aaa_fetch_data():
    ...
    try:
        if str(key) == str(inpkey):
            try:
                ...
                # url = API_URL + f"&case_ids={cases_id}"
                # print("url is : ", url)
                ...
                data = {"823797": {
                    ...
                    "plaintiff": "HOLLIS HEALING PRO INC", "defendant": "PROGRESSIVE INSURANCE COMPANY",
                    "patientName": "ANTHONY HARRISON",
    ...
    # TODO
    # resp = requests.post(
    #     "https://gabrielmoroff.com/liberation/functions/check_qcprocess_status?&key=LBATQrQzP8qp2YVxWfHlJFV3VZ1mWIO7")
