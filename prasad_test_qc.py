    ...
    try:
        if str(key) == str(inpkey):
            try:
                ...
                # data = {"823797": {
                #     "filepath": "/home/neural/Documents/Python_workspace/QC/jul04/828747.pdf",
                #     "plaintiff": "HOLLIS HEALING PRO INC", "defendant": "PROGRESSIVE INSURANCE COMPANY", "patientName": "ANTHONY HARRISON",
                #     "dos_s": "06/18/2024", "dos_e": "07/01/2024", "initial_amt": "1031.43"}}
